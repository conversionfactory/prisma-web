...
export const CUSTOMER_STORY_DETAILS: CustomerStoryDetail[] = [
  ...
  },
  {
    ...
    hero: {
      title:
        "How Rapha keeps data consistent across mobile, web, and its clubhouses with Prisma",
  ...
  },
  {
    ...
    challenge: {
      heading: "The challenge",
      body: ["Invisible started on Sequelize, but as the platform grew, the ORM became a constraint:"],
      points: [
        {
          icon: "code",
  ...
  },
  {
    ...
    about: {
      ...
      facts: [
        ...
        { icon: "shield", label: "Compliance", value: "HIPAA" },
        {
          icon: "layers",
          label: "Stack",
          value: "GraphQL (Apollo), GraphQL Nexus, GCP serverless, PostgreSQL, TypeScript, Stripe, Firebase",
        },
    ...
    challenge: {
      ...
      outro:
        "For one developer, that left no room to spend time hand-managing the database.",
    },
    reasons: {
    ...
    about: {
      ...
      facts: [
        ...
        },
        {
          icon: "layers",
          label: "Stack",
          value: "Node.js (Fastify), React Native, PostgreSQL + PostGIS, Redis, Twilio, Docker, GCP, BigQuery",
        },
    ...
    about: {
      ...
      facts: [
        ...
        { icon: "settings", label: "Product", value: "Smart pool sensor and app" },
        {
          icon: "layers",
          label: "Stack",
          value: "React Native, GraphQL (Apollo), AWS Lambda, Nexus, PostgreSQL, DynamoDB, TypeScript",
        },
        {
          icon: "database",
          label: "Using",
