    ...
    <section className="bg-white px-4 py-24 sm:px-8 sm:py-32">
      <div className="mx-auto max-w-site">
        <div className="grid gap-14 lg:grid-cols-2 lg:gap-20">
          ...
          <Reveal delay={0.15} className="relative flex items-center justify-center overflow-hidden rounded-2xl border border-black/[0.06] bg-[url('/brand/agent-loop.jpg')] bg-[length:135%] bg-[position:50%_100%] p-6 sm:p-8">
