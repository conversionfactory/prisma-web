...
// 2026-08-17). The panel keeps no band of its own: with the controls directly
// below it, a second row of chips in the hero would read as two controls for
// one grid.
//
// The hero briefly took the whole index as children, /pricing style. That was
// too far (André, 2026-08-17): the pricing container is for the LIST, not the
// page. It lives in blog-browser.tsx now and this panel is a hero again.
//
