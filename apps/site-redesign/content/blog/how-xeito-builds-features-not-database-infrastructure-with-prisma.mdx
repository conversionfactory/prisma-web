...
description: "How Xeito uses Prisma ORM and Prisma Postgres to ship live scoring, leagues, payments, and player workflows without a database team."
date: "2026-06-30"
author: "Gregory Boch"
tags: ["case-study", "platform", "orm", "prisma-postgres"]
---
...
<img
  ...
  src="/how-xeito-builds-features-not-database-infrastructure-with-prisma/imgs/xeito-club.png"
  alt="Xeito club page showing Malta Squash, members, and a league entry"
/>

<img
  className="my-8 w-full rounded-xl border border-gray-200 bg-white shadow-xl shadow-gray-950/10"
  src="/how-xeito-builds-features-not-database-infrastructure-with-prisma/imgs/xeito-league.png"
