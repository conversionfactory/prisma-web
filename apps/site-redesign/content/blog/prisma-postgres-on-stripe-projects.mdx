...
description: "Add a Prisma Postgres database to your Stripe project with one command: spending limits out of the box, plan changes from the CLI you already use."
date: "2026-06-26"
author: "Sampo Lahtinen"
tags: ["announcement", "prisma-postgres"]
---
